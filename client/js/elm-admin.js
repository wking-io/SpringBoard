...
var author$project$Admin$Goodbye = 1;
var author$project$Admin$Hello = 0;
...
var author$project$Admin$say = function (hello) {
	return hello ? _List_fromArray(
		[
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('Hello there friend!')
				])),
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text('Say goodbye 👋')
				]))
		]) : _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text('See you later!')
				])),
			A2(
			elm$html$Html$button,
			_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$div,
				_List_Nil,
				author$project$Admin$say(model))
			]));
};
...
var author$project$Admin$main = elm$browser$Browser$element(
	{ar: author$project$Admin$init, ax: author$project$Admin$subscriptions, az: author$project$Admin$update, aB: author$project$Admin$view});
