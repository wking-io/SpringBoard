...
var author$project$Admin$Model = function (processList) {
	return {processList: processList};
};
var author$project$Admin$Active = F2(
	function (a, b) {
		return {$: 'Active', a: a, b: b};
	});
var author$project$Admin$Id = function (a) {
	return {$: 'Id', a: a};
};
var author$project$Admin$Inactive = F2(
	function (a, b) {
		return {$: 'Inactive', a: a, b: b};
	});
...
var author$project$Admin$fakeProcessess = _List_fromArray(
	[
		A2(
		author$project$Admin$Active,
		{
		...
		},
		{
			...
			id: author$project$Admin$Id('123456'),
			title: 'Weekly blog update for MegaMaker Community article'
		}),
		A2(
		author$project$Admin$Inactive,
		{
			completedCount: 12,
			lastCompleted: elm$time$Time$millisToPosix(1565984035514)
		},
		{
			description: 'Weekly blog update for MegaMaker Community article. Done once a week to make sure that new topics are covered.',
			id: author$project$Admin$Id('123457'),
			title: 'Weekly blog update for MegaMaker Community article'
		})
	]);
...
var author$project$Admin$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Admin$Model(author$project$Admin$fakeProcessess),
...
var author$project$Admin$renderProcessList = function (process) {
	if (process.$ === 'Active') {
		var activeData = process.a;
		var id = process.b.id;
		var title = process.b.title;
		var description = process.b.description;
		return A2(
			elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$ul,
						_List_Nil,
						A2(elm$core$List$map, author$project$Admin$renderProcessList, model.processList))
					]))
			]));
};
