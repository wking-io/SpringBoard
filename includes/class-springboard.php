 ...
 * public-facing side of the site and the server area.
 *
 * @link       https://wking.io
 * @since      1.0.0
 *
 ...
 *
 * This is used to define internationalization, server-specific hooks, and
...
class SpringBoard {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      SpringBoard_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * Load the dependencies, define the locale, and set the hooks for the server area and
	 ...
	 *
	 * - SpringBoard_Loader. Orchestrates the hooks of the plugin.
	 * - SpringBoard_i18n. Defines internationalization functionality.
	 * - SpringBoard_Admin. Defines all hooks for the server area.
	 * - SpringBoard_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-springboard-loader.php';
	 ...
	 *
	 * Uses the SpringBoard_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new SpringBoard_i18n();
		$this->loader->add_action( 'plugins_loaded', $plugin_i18n, 'load_plugin_textdomain' );

	}

	/**
	 * Register all of the hooks related to the server area functionality
	 * of the plugin.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    SpringBoard_Loader    Orchestrates the hooks of the plugin.
	 */
